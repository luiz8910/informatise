<div class="be-content">
    <div class="main-content container-fluid">
        <div class="row">
            <div class="col-md-12">
                <a href="javascript:" class="btn btn-primary btn-list" onclick="add_model('{!! $model !!}')">
                    <i class="fas fa-users"></i> Adicionar
                </a>
            </div>
        </div>
        <div class="row">
                            ...
                            @foreach($people as $person)
                                <tr id="model_{{ $person->id }}">
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="javascript:" onclick="destroy({!! $person->id !!})" class="icon"><i class="mdi mdi-delete" style="margin-left: 10px;"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
